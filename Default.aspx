<%@ Page Title="" Language="VB" MasterPageFile="~/Blackhawks.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
        ...
        <UpdateParameters>
         ...
         <asp:GridView ID="Home_GridView" CssClass="gridview" HorizontalAlign="Center" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="playerID" DataSourceID="HW7_Home_DataSource" Height="275px" Width="550px">
            <Columns>
