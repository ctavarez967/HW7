<%@ Page Title="" Language="VB" MasterPageFile="~/Blackhawks.master" AutoEventWireup="false" CodeFile="Roster.aspx.vb" Inherits="Roster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
         ...
         <asp:SqlDataSource ID="Roster_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:db_ctavarez_HW7 %>" SelectCommand="SELECT * FROM [ctavarez_HW7] WHERE ([playerID] = @playerID)">
            ...
            <br />
        <asp:DetailsView ID="DetailsView_Roster" HorizontalAlign ="Center" runat="server" AutoGenerateRows="False" CssClass="detailView" DataKeyNames="playerID" DataSourceID="Roster_DataSource" >
            <Fields>
